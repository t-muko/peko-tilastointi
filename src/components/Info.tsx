		...
		return (
			...
			><Paper sx={{ p: 1 }}>
					...
					<Typography variant="body1" gutterBottom>
						...
						toimia reenipäiväkirjana tai muistiinpanovälineenä mitä milloinkin 
						on tullut tehtyä. Toisaalta on hyvä vähän tilastoida mitä on tullut tehtyä,
						kun muistiin ei ihan aina kannata luottaa. "On me reenattu tätä ainakin 20 kertaa",
						sanoi joku... ja tilastomerkinnät kertoivat vain viidestä harjoituksesta.
						Ajatus onkin kääntää tilastointi
					...
					<ul>
						...
						<li> Kirjaukset näkyvät vain sinulle. Muut käyttäjät eivät näe mitään yksityiskohtia.</li>
						...
						<li> Kategoriajako on tarkoituksella melko korkealla tasolla, jotta käyttö on nopeaa. Valitse kategoria "pääasiallisen" teeman mukaan.
							Muistiinpanoihin voi lisätä hashtagejä esim. #vesistöetsintä, #rakennusetsintä jne. Muu reeni -kategoriaa
						...
						<li> Voit niputtaa yhteen merkintään päivän kaikki jutut, tai tehdä useamman merkinnän.
							Tilatoinnissa merkintöjen määrä on toki mielenkiintoinen,  
							mutta niin ovat myös tunnit ja teemat, 
							sekä toissijaisesti monenako päivänä viikossa jotain toimintaa tehdään.
							Ajokilometrien kirjaamisen voi kukin hyödyntää neuvotteluargumenttina 
							seuraavaa autoa hankittaessa...</li>
						<li> Tämän tarkoitus on olla yksilön oma helppokäyttöinen kirjanpitoväline - <i>rakas päiväkirja...</i></li>
						<li> Merkinnöistä lasketaan anynyymia tilastotietoa yhteenvetotasolla. Oma yhdisyts
							vaikuttaa vain tilastoinnin viiteryhmään, mutta omien reenien avaaminen esim.
						...
						<li>Voit ladata kaikki merkintäsi CSV-tiedostona harjoituslistasi lopussa olevalla linkillä.</li>
						<li> Kaikenlaista yksilöivää tietoa vältetään kuin ruttoa EU:n tietosuoja-asetusta mukaillen</li>
						<li> Tiedot tallennetaan Googlen pilveen Euroopassa, eikä tietoja käytetä mihinkään muuhun tarkoitukseen, kuin tähän äppiin.</li>
						<li> Palvelu ei tallenna nimeä tai sähköpostiosoitettasi tietojen yhteyteen, 
							vaan tiedot liitetään teknisen tunnisteen avulla Google-kirjautumiseen. (uid).
					...
					<Typography variant="body1" gutterBottom>
						Kategoriajako on karkea, jotta käyttö on nopeaa eikä sopivaa kategoriaa tarvitse
					...
					<Typography variant="body1" gutterBottom>
						...
						Ohjaajan kannalta taas tärkeä on sokkoharjoitus, jossa sovelletaan 
						kaikkea opittua. Tämä kategoria on nimetty lyhyesti
						'partsa'-nimellä. Tällä ei siis viitata koeohjeen partiointiin.</Typography>

					<Typography variant="body1" gutterBottom>Merkitse muistiinpanoihin haluamasi tarkenteet 
						#hashtageilla. Nämä löytyvät hakutoiminnolla, jolloin
						pystyt helposti tarkistamaan että montako kertaa on tullut taajamaetsintää harjoiteltua. 
						Taajamassa reenataan todennäköisesti joko
						koiran ilmavainutyöskentelyä tai sitten partsaa eli koiran reaktioiden lukemista. 
					</Typography>
